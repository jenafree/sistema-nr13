  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "responsabilidades":
        return (
          <div className="tab-combined-content">
            <Responsabilidades
              formData={formData}
              setFormData={setFormData}
            />
      ...
      // === CASES COMENTADOS (ativação futura) ===
      // case "resumo":
      //   return <Formulario formData={formData} setFormData={setFormData} />;
      // case "exameDocumentacao":
      //   return <ExameDocumentacao formData={formData} setFormData={setFormData} />;
      // case "relatorioAnterior":
      //   return <InformacoesRelatorioAnterior formData={formData} setFormData={setFormData} />;
      // case "instalacoes":
      //   return <Instalacoes formData={formData} setFormData={setFormData} />;
      // case "exameExterno":
      //   return <ExameExterno formData={formData} setFormData={setFormData} />;
      // case "exameInterno":
      //   return <ExameInterno formData={formData} setFormData={setFormData} />;
      // case "ensaios":
      //   return <EnsaiosRealizados formData={formData} setFormData={setFormData} />;
      // case "recomendacoes":
      //   return <Recomendacoes formData={formData} setFormData={setFormData} />;
      // case "conclusao":
      //   return <Conclusao formData={formData} setFormData={setFormData} />;
      // case "proximasInspecoes":
      //   return <ProximasInspecoes formData={formData} setFormData={setFormData} />;
      // case "anexos":
      //   return <Anexos formData={formData} setFormData={setFormData} />;
      // case "termoInspecao":
      //   return <TermoInspecao formData={formData} setFormData={setFormData} />;
